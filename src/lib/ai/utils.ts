  ...
  return [
    {
      ...
      content: `
        ...
        This should follow the standard format for a formal letter, with paragraphs.
        Do not include skills or experiences that are not present in the resume, even if they are in the job description.
